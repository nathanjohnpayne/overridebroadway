    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold tracking-tight">Override</h1>
          <p className="text-sm text-muted-foreground mt-1">You run the show. Override runs the money.</p>
        </div>
        <Card>
          <CardHeader>
            <CardTitle>Create an account</CardTitle>
            <CardDescription>Start modeling Broadway investments today.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleEmailSignup} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="name" value={displayName} onChange={e => setDisplayName(e.target.value)} required placeholder="Nathan Payne" />
              </div>
              <div className="space-y-2">
